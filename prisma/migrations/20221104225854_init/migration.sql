...
CREATE TABLE `User` (
    ...
    `emailisverfied` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `Post` (
    ...
    `UndercoverParking` BOOLEAN NOT NULL DEFAULT false,
    `airConditioning` BOOLEAN NOT NULL DEFAULT false,
    `solarPanels` BOOLEAN NOT NULL DEFAULT false,
    `SolarHotwater` BOOLEAN NOT NULL DEFAULT false,
